...
./krankybearnotify -title "Test basic" -message "This is a very long message that should wrap properly instead of being truncated to match the title width. The text should flow nicely across multiple lines with proper word wrapping." -timeout 0 -image KrankyBearBeret.png -force-basic

./krankybearnotify -title "Test webview" -message "This is a very long message that should wrap properly instead of being truncated to match the title width. The text should flow nicely across multiple lines with proper word wrapping." -timeout 0 -image KrankyBearBeret.png -force-webview -timeout 5